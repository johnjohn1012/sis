      ...
      <!-- Footer -->
      <footer class="sticky-footer bg-white" style="height: 50px; padding: 10px 0;">
        <div class="container my-auto">
        <div class="copyright text-center margin-botton" style="background-color:rgb(255, 255, 255); padding: 10px 0; text-align: center; width: 100%;">
          <span>Copyright © Harah Rubina Del Dios Sales and Inventory System 2025 By Capstone Group</span>
        </div>
